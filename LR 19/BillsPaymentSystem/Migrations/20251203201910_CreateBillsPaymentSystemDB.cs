...
{
    /// <inheritdoc />
    public partial class CreateBillsPaymentSystemDB : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MoneyOwed = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_PaymentMethodCreditCardOrBankAccount", "(BankAccountId IS NULL AND CreditCardId IS NOT NULL) OR CreditCardId IS NULL AND BankAccountId IS NOT NULL");
                    table.ForeignKey(
